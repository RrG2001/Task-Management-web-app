...
Route::group(['prefix' => 'tasks'], function () {
    ...
    Route::get('/filter', [\App\Http\Controllers\TaskController::class, 'getFilteredTasks']);
    Route::get('/no-assignee', [\App\Http\Controllers\TaskController::class, 'noAssignee']);
});

Route::group(['prefix' => 'projects'], function () {
    Route::post('/multipleProjects', [\App\Http\Controllers\ProjectController::class, 'createMultipleProjects']);
